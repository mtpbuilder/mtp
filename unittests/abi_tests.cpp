...
auto get_resolver(const abi_def& abi = abi_def())
{
   return [&abi](const account_name &name) -> optional<abi_serializer> {
      return abi_serializer(mtpio_contract_abi(abi), abi_serializer::create_yield_function( max_serialization_time ));
   };
}
...
{ try {
   ...
   abi_serializer abis(mtpio_contract_abi(abi), abi_serializer::create_yield_function( max_serialization_time ));
...
{ try {
   ...
   auto abi = mtpio_contract_abi(fc::json::from_string(my_abi).as<abi_def>());

   abi_serializer abis(abi, abi_serializer::create_yield_function( max_serialization_time ));

   const char *my_other = R"=====(
    {
      "publickey"     :  "MTP6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV",
      "publickey_arr" :  ["MTP6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV","MTP6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV","MTP6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV"],
      "asset"         : "100.0000 SYS",
      ...
      "keyweight": {"key":"MTP6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV", "weight":"100"},
      "keyweight_arr": [{"key":"MTP6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV", "weight":"100"},{"key":"MTP6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV", "weight":"200"}],
      "authority": {
         "threshold":"10",
         "keys":[{"key":"MTP6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV", "weight":100},{"key":"MTP6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV", "weight":200}],
...
{ try {
   ...
   auto abi = mtpio_contract_abi(fc::json::from_string(typedef_cycle_abi).as<abi_def>());
...
{ try {
   ...
   abi_serializer abis(mtpio_contract_abi(abi_def()), abi_serializer::create_yield_function( max_serialization_time ));
...
{ try {
   ...
   const char* test_data = R"=====(
   {
     ...
     "auth" : {
        ...
        "keys" : [ {"key" : "MTP65rXebLhtk2aTTzP4e9x1AQZs7c5NNXJp89W8R3HyaA6Zyd4im", "weight" : 57005},
                   {"key" : "MTP5eVr9TVnqwnUBNwf9kwMTbrHvX5aPyyEG97dz2b2TNeqWRzbJf", "weight" : 57605} ],
   ...
   BOOST_TEST("MTP65rXebLhtk2aTTzP4e9x1AQZs7c5NNXJp89W8R3HyaA6Zyd4im" == updauth.auth.keys[0].key.to_string());
   BOOST_TEST(57005u == updauth.auth.keys[0].weight);
   BOOST_TEST("MTP5eVr9TVnqwnUBNwf9kwMTbrHvX5aPyyEG97dz2b2TNeqWRzbJf" == updauth.auth.keys[1].key.to_string());
...
{ try {
   ...
   BOOST_TEST("MTP65rXebLhtk2aTTzP4e9x1AQZs7c5NNXJp89W8R3HyaA6Zyd4im" == newacct.owner.keys[0].key.to_string());
   BOOST_TEST(57005u == newacct.owner.keys[0].weight);
   BOOST_TEST("MTP5eVr9TVnqwnUBNwf9kwMTbrHvX5aPyyEG97dz2b2TNeqWRzbJf" == newacct.owner.keys[1].key.to_string());
   ...
   BOOST_TEST("MTP65rXebLhtk2aTTzP4e9x1AQZs7c5NNXJp89W8R3HyaA6Zyd4im" == newacct.active.keys[0].key.to_string());
   BOOST_TEST(57005u == newacct.active.keys[0].weight);
   BOOST_TEST("MTP5eVr9TVnqwnUBNwf9kwMTbrHvX5aPyyEG97dz2b2TNeqWRzbJf" == newacct.active.keys[1].key.to_string());
...
{ try {
   ...
   abi_serializer abis(mtpio_contract_abi(v.as<abi_def>()), abi_serializer::create_yield_function( max_serialization_time ));
...
{ try {
   ...
   auto abi = mtpio_contract_abi(fc::json::from_string(repeat_abi).as<abi_def>());
...
BOOST_AUTO_TEST_CASE(abi_account_name_in_mtpio_abi)
{ try {
   // inifinite loop in types
   const char* repeat_abi = R"=====(
   {
...
BOOST_AUTO_TEST_CASE(abi_large_array)
{
   try {
      ...
      // curl http://127.0.0.1:8888/v1/chain/abi_bin_to_json -X POST -d '{"code":"mtpio", "action":"hi", "binargs":"ffffffff08"}'
...
{
   using mtpio::testing::fc_exception_message_starts_with;

   auto duplicate_variant_abi = R"({
      "version": "mtpio::abi/1.1",
      "variants": [
...
BOOST_AUTO_TEST_CASE(version)
{
   try {
      ...
      BOOST_CHECK_THROW( abi_serializer(fc::json::from_string(R"({"version": "mtpio::abi/9.0"})").as<abi_def>(), abi_serializer::create_yield_function( max_serialization_time )), unsupported_abi_version_exception );
      abi_serializer(fc::json::from_string(R"({"version": "mtpio::abi/1.0"})").as<abi_def>(), abi_serializer::create_yield_function( max_serialization_time ));
      abi_serializer(fc::json::from_string(R"({"version": "mtpio::abi/1.1"})").as<abi_def>(), abi_serializer::create_yield_function( max_serialization_time ));
   } FC_LOG_AND_RETHROW()
}
...
{
   using mtpio::testing::fc_exception_message_is;
