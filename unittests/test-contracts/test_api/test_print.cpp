...
void test_print::test_printn() {
   printn(mtpio::name{"1"}.value);
   printn(mtpio::name{"5"}.value);
   printn(mtpio::name{"a"}.value);
   printn(mtpio::name{"z"}.value);

   printn(mtpio::name{"abc"}.value);
   printn(mtpio::name{"123"}.value);

   printn(mtpio::name{"abc.123"}.value);
   printn(mtpio::name{"123.abc"}.value);

   printn(mtpio::name{"12345abcdefgj"}.value);
   printn(mtpio::name{"ijklmnopqrstj"}.value);
   printn(mtpio::name{"vwxyz.12345aj"}.value);

   printn(mtpio::name{"111111111111j"}.value);
   printn(mtpio::name{"555555555555j"}.value);
   printn(mtpio::name{"aaaaaaaaaaaaj"}.value);
   printn(mtpio::name{"zzzzzzzzzzzzj"}.value);
}
