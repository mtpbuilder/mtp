...
namespace _test_multi_index {
   ...
   struct record_idx64 {
      ...
      MTPLIB_SERIALIZE( record_idx64, (id)(sec) )
   };
   ...
   struct record_idx128 {
      ...
      MTPLIB_SERIALIZE( record_idx128, (id)(sec) )
   };
   ...
   struct record_idx256 {
      ...
      MTPLIB_SERIALIZE( record_idx256, (id)(sec) )
   };
   ...
   struct record_idx_double {
      ...
      MTPLIB_SERIALIZE( record_idx_double, (id)(sec) )
   };
   ...
   struct record_idx_long_double {
      ...
      MTPLIB_SERIALIZE( record_idx_long_double, (id)(sec) )
   };
