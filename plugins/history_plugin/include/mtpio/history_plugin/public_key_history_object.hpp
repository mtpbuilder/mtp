...
CHAINBASE_SET_INDEX_TYPE( mtpio::public_key_history_object, mtpio::public_key_history_multi_index )

FC_REFLECT( mtpio::public_key_history_object, (public_key)(name)(permission) )
