...
CHAINBASE_SET_INDEX_TYPE( mtpio::account_control_history_object, mtpio::account_control_history_multi_index )

FC_REFLECT( mtpio::account_control_history_object, (controlled_account)(controlled_permission)(controlling_account) )
