#include <mtpio/producer_api_plugin/producer_api_plugin.hpp>
...
FC_REFLECT(mtpio::detail::producer_api_plugin_response, (result));
...
#define INVOKE_V_R(api_handle, call_name, in_param) \
     ...
     mtpio::detail::producer_api_plugin_response result{"ok"};
