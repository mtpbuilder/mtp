...
#include <mtpio/trace_api/metadata_log.hpp>
#include <mtpio/trace_api/data_log.hpp>
#include <mtpio/trace_api/compressed_file.hpp>

namespace mtpio::trace_api {
...
FC_REFLECT(mtpio::trace_api::slice_directory::index_header, (version))
