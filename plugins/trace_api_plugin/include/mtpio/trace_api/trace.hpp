...
FC_REFLECT(mtpio::trace_api::authorization_trace_v0, (account)(permission))
FC_REFLECT(mtpio::trace_api::action_trace_v0, (global_sequence)(receiver)(account)(action)(authorization)(data))
FC_REFLECT(mtpio::trace_api::transaction_trace_v0, (id)(actions))
FC_REFLECT(mtpio::trace_api::block_trace_v0, (id)(number)(previous_id)(timestamp)(producer)(transactions))
