...
read -d '' genesis << EOF
{
  ...
  "initial_key": "MTP6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV",
...
private-key = ['MTP6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV','5KQwrPbwdL6PhXujxW37FSSQZ1JiwsST4cqQzDeyXtP79zkvFD3']
...
programs/mtpio-launcher/mtpio-launcher -p $pnodes -n $total_nodes --nogen -d $delay
...
b5idbios=`./programs/clmtp/clmtp -u http://localhost:8888 get block 5 | grep "^ *\"id\""`
b5id00=`./programs/clmtp/clmtp -u http://localhost:8889 get block 5 | grep "^ *\"id\""`
b5id01=`./programs/clmtp/clmtp -u http://localhost:8890 get block 5 | grep "^ *\"id\""`
