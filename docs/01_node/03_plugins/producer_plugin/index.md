...
```console
# config.ini
plugin = mtpio::producer_plugin [options]
```
```sh
...
```console
Config Options for mtpio::producer_plugin:
  ...
  --private-key arg                     (DEPRECATED - Use signature-provider 
                                        ...
                                        times)
  --signature-provider arg (=MTP6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV=KEY:5KQwrPbwdL6PhXujxW37FSSQZ1JiwsST4cqQzDeyXtP79zkvFD3)
                                        Key=Value pairs in the form 
                                        <public-key>=<provider-spec>
                                        Where:
                                           <public-key>    is a string form of 
                                                           a vaild MTPIO public
                                                           key
                                           ...
                                           KMTPD:<data>    is the URL where 
                                                           kmtpd is available 
                                                           and the approptiate 
                                                           wallet(s) are 
                                                           unlocked
  --kmtpd-provider-timeout arg (=5)     Limits the maximum time (in 
                                        milliseconds) that is allowed for 
                                        sending blocks to a kmtpd provider for 
                                        signing
