...
## Examples
Simply output the hash of mtpio.token contract 

```sh
clmtp get code mtpio.token
```
```console
...
```sh
clmtp get code mtpio.token -a mtpio.token.abi
```
```console
code hash: f675e7aeffbf562c033acfaf33eadff255dacb90d002db51c7ad7cbf057eb791
...
Retrieve and save wast code for mtpio.token contract

```sh
clmtp get code mtpio.token -c mtpio.token.wast
```
```console
code hash: f675e7aeffbf562c033acfaf33eadff255dacb90d002db51c7ad7cbf057eb791
saving wast to mtpio.token.wast
```
