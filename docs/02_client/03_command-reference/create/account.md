...
## Command
A set of MTPIO keys is required to create an account. The MTPIO keys can be generated by using `clmtp create key`.

```sh
clmtp create account inita tester MTP4toFS3YXEQCkuuw1aqDLrtHim86Gz9u3hBdcBw5KNPZcursVHq MTP7d9A3uLe6As66jzN8j44TXJUqJSK3bFjjEEqR4oTvNAB3iM9SA
```
