...
- `sender` _TEXT_ - The account sending MTP
- `recipient` _TEXT_ - The account receiving MTP
- `amount` _UINT_ - The amount of MTP to send
...
```sh
clmtp transfer inita tester 1000
```
