...
mkdir -p ${PROJECT}/${VERSION}/opt/mtpio/lib/cmake
...
echo "class mtpio < Formula

   homepage \"${URL}\"
   revision 0
   url \"https://github.com/mtpio/mtp/archive/v${VERSION}.tar.gz\"
   version \"${VERSION}\"
   ...
   bottle do
      root_url \"https://github.com/mtpio/mtp/releases/download/v${VERSION}\"
