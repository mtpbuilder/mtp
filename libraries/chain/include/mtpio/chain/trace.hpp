...
#include <mtpio/chain/action_receipt.hpp>
...
FC_REFLECT( mtpio::chain::account_delta,
            (account)(delta) )

FC_REFLECT( mtpio::chain::action_trace,
...
FC_REFLECT( mtpio::chain::transaction_trace, (id)(block_num)(block_time)(producer_block_id)
