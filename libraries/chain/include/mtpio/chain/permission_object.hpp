...
CHAINBASE_SET_INDEX_TYPE(mtpio::chain::permission_object, mtpio::chain::permission_index)
CHAINBASE_SET_INDEX_TYPE(mtpio::chain::permission_usage_object, mtpio::chain::permission_usage_index)

FC_REFLECT(mtpio::chain::permission_object, (usage_id)(parent)(owner)(name)(last_updated)(auth))
FC_REFLECT(mtpio::chain::snapshot_permission_object, (parent)(owner)(name)(last_updated)(last_used)(auth))

FC_REFLECT(mtpio::chain::permission_usage_object, (last_used))
