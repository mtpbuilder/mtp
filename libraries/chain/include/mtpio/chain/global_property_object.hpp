...
#include <mtpio/chain/incremental_merkle.hpp>
...
CHAINBASE_SET_INDEX_TYPE(mtpio::chain::global_property_object, mtpio::chain::global_property_multi_index)
CHAINBASE_SET_INDEX_TYPE(mtpio::chain::dynamic_global_property_object,
                         mtpio::chain::dynamic_global_property_multi_index)

FC_REFLECT(mtpio::chain::global_property_object,
            (proposed_schedule_block_num)(proposed_schedule)(configuration)(chain_id)
          )

FC_REFLECT(mtpio::chain::legacy::snapshot_global_property_object_v2,
            (proposed_schedule_block_num)(proposed_schedule)(configuration)
          )

FC_REFLECT(mtpio::chain::snapshot_global_property_object,
            (proposed_schedule_block_num)(proposed_schedule)(configuration)(chain_id)
          )

FC_REFLECT(mtpio::chain::dynamic_global_property_object,
