...
constexpr auto intrinsic_table = boost::hana::make_tuple(
   "mtpvmoc_internal.unreachable"_s,
   "mtpvmoc_internal.grow_memory"_s,
   "mtpvmoc_internal.div0_or_overflow"_s,
   "mtpvmoc_internal.indirect_call_mismatch"_s,
   "mtpvmoc_internal.indirect_call_oob"_s,
   "mtpvmoc_internal.depth_assert"_s,
   "mtpio_injection.call_depth_assert"_s,  //these two are never used by MTP VM OC but all intrinsics
   "mtpio_injection.checktime"_s,          //must be mapped
   "env.__ashlti3"_s,
   "env.__ashrti3"_s,
   "env.__lshlti3"_s,
   "env.__lshrti3"_s,
   ...
   "env.abort"_s,
   "env.mtpio_assert"_s,
   "env.mtpio_assert_message"_s,
   "env.mtpio_assert_code"_s,
   "env.mtpio_exit"_s,
   ...
   "env.memcmp"_s,
   "env.memset"_s,
   "mtpio_injection._mtpio_f32_add"_s,
   "mtpio_injection._mtpio_f32_sub"_s,
   "mtpio_injection._mtpio_f32_mul"_s,
   "mtpio_injection._mtpio_f32_div"_s,
   "mtpio_injection._mtpio_f32_min"_s,
   "mtpio_injection._mtpio_f32_max"_s,
   "mtpio_injection._mtpio_f32_copysign"_s,
   "mtpio_injection._mtpio_f32_abs"_s,
   "mtpio_injection._mtpio_f32_neg"_s,
   "mtpio_injection._mtpio_f32_sqrt"_s,
   "mtpio_injection._mtpio_f32_ceil"_s,
   "mtpio_injection._mtpio_f32_floor"_s,
   "mtpio_injection._mtpio_f32_trunc"_s,
   "mtpio_injection._mtpio_f32_nearest"_s,
   "mtpio_injection._mtpio_f32_eq"_s,
   "mtpio_injection._mtpio_f32_ne"_s,
   "mtpio_injection._mtpio_f32_lt"_s,
   "mtpio_injection._mtpio_f32_le"_s,
   "mtpio_injection._mtpio_f32_gt"_s,
   "mtpio_injection._mtpio_f32_ge"_s,
   "mtpio_injection._mtpio_f64_add"_s,
   "mtpio_injection._mtpio_f64_sub"_s,
   "mtpio_injection._mtpio_f64_mul"_s,
   "mtpio_injection._mtpio_f64_div"_s,
   "mtpio_injection._mtpio_f64_min"_s,
   "mtpio_injection._mtpio_f64_max"_s,
   "mtpio_injection._mtpio_f64_copysign"_s,
   "mtpio_injection._mtpio_f64_abs"_s,
   "mtpio_injection._mtpio_f64_neg"_s,
   "mtpio_injection._mtpio_f64_sqrt"_s,
   "mtpio_injection._mtpio_f64_ceil"_s,
   "mtpio_injection._mtpio_f64_floor"_s,
   "mtpio_injection._mtpio_f64_trunc"_s,
   "mtpio_injection._mtpio_f64_nearest"_s,
   "mtpio_injection._mtpio_f64_eq"_s,
   "mtpio_injection._mtpio_f64_ne"_s,
   "mtpio_injection._mtpio_f64_lt"_s,
   "mtpio_injection._mtpio_f64_le"_s,
   "mtpio_injection._mtpio_f64_gt"_s,
   "mtpio_injection._mtpio_f64_ge"_s,
   "mtpio_injection._mtpio_f32_promote"_s,
   "mtpio_injection._mtpio_f64_demote"_s,
   "mtpio_injection._mtpio_f32_trunc_i32s"_s,
   "mtpio_injection._mtpio_f64_trunc_i32s"_s,
   "mtpio_injection._mtpio_f32_trunc_i32u"_s,
   "mtpio_injection._mtpio_f64_trunc_i32u"_s,
   "mtpio_injection._mtpio_f32_trunc_i64s"_s,
   "mtpio_injection._mtpio_f64_trunc_i64s"_s,
   "mtpio_injection._mtpio_f32_trunc_i64u"_s,
   "mtpio_injection._mtpio_f64_trunc_i64u"_s,
   "mtpio_injection._mtpio_i32_to_f32"_s,
   "mtpio_injection._mtpio_i64_to_f32"_s,
   "mtpio_injection._mtpio_ui32_to_f32"_s,
   "mtpio_injection._mtpio_ui64_to_f32"_s,
   "mtpio_injection._mtpio_i32_to_f64"_s,
   "mtpio_injection._mtpio_i64_to_f64"_s,
   "mtpio_injection._mtpio_ui32_to_f64"_s,
   "mtpio_injection._mtpio_ui64_to_f64"_s
);
