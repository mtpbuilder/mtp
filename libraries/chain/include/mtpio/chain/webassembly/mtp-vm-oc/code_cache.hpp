...
namespace std {
    template<> struct hash<mtpio::chain::mtpvmoc::code_tuple> {
        size_t operator()(const mtpio::chain::mtpvmoc::code_tuple& ct) const noexcept {
...
class code_cache_base {
   public:
      code_cache_base(const bfs::path data_dir, const mtpvmoc::config& mtpvmoc_config, const chainbase::database& db);
      ~code_cache_base();
...
class code_cache_async : public code_cache_base {
   public:
      code_cache_async(const bfs::path data_dir, const mtpvmoc::config& mtpvmoc_config, const chainbase::database& db);
      ~code_cache_async();
