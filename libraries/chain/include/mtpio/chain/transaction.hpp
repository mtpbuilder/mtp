...
#include <mtpio/chain/action.hpp>
#include <numeric>
...
FC_REFLECT(mtpio::chain::deferred_transaction_generation_context, (sender_trx_id)(sender_id)(sender) )
FC_REFLECT( mtpio::chain::transaction_header, (expiration)(ref_block_num)(ref_block_prefix)
                                              (max_net_usage_words)(max_cpu_usage_ms)(delay_sec) )
FC_REFLECT_DERIVED( mtpio::chain::transaction, (mtpio::chain::transaction_header), (context_free_actions)(actions)(transaction_extensions) )
FC_REFLECT_DERIVED( mtpio::chain::signed_transaction, (mtpio::chain::transaction), (signatures)(context_free_data) )
FC_REFLECT_ENUM( mtpio::chain::packed_transaction::compression_type, (none)(zlib))
// @ignore unpacked_trx
FC_REFLECT( mtpio::chain::packed_transaction, (signatures)(compression)(packed_context_free_data)(packed_trx) )
