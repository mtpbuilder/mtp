...
FC_REFLECT(mtpio::chain::permission_level_weight, (permission)(weight) )
FC_REFLECT(mtpio::chain::key_weight, (key)(weight) )
FC_REFLECT(mtpio::chain::wait_weight, (wait_sec)(weight) )
FC_REFLECT(mtpio::chain::authority, (threshold)(keys)(accounts)(waits) )
FC_REFLECT(mtpio::chain::shared_key_weight, (key)(weight) )
FC_REFLECT(mtpio::chain::shared_authority, (threshold)(keys)(accounts)(waits) )
FC_REFLECT(mtpio::chain::shared_public_key, (pubkey))