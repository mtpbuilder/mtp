...
CHAINBASE_SET_INDEX_TYPE(mtpio::chain::code_object, mtpio::chain::code_index)

FC_REFLECT(mtpio::chain::code_object, (code_hash)(code)(code_ref_count)(first_block_used)(vm_type)(vm_version))
