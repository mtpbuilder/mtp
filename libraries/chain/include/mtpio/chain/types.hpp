...
namespace mtpio { namespace chain {
   ...
   /**
    *  Important notes on using chainbase objects in MTPIO code:
    *
    ...
    *  others are due to requirements to ensure determinism in the MTPIO chain library.
    *
...
FC_REFLECT_EMPTY( mtpio::chain::void_t )
