...
CHAINBASE_SET_INDEX_TYPE(mtpio::chain::transaction_object, mtpio::chain::transaction_multi_index)

FC_REFLECT(mtpio::chain::transaction_object, (expiration)(trx_id))
