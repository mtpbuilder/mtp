...
#include <mtpio/chain/multi_index_includes.hpp>
...
CHAINBASE_SET_INDEX_TYPE(mtpio::chain::table_id_object, mtpio::chain::table_id_multi_index)
CHAINBASE_SET_INDEX_TYPE(mtpio::chain::key_value_object, mtpio::chain::key_value_index)

CHAINBASE_SET_INDEX_TYPE(mtpio::chain::index64_object, mtpio::chain::index64_index)
CHAINBASE_SET_INDEX_TYPE(mtpio::chain::index128_object, mtpio::chain::index128_index)
CHAINBASE_SET_INDEX_TYPE(mtpio::chain::index256_object, mtpio::chain::index256_index)
CHAINBASE_SET_INDEX_TYPE(mtpio::chain::index_double_object, mtpio::chain::index_double_index)
CHAINBASE_SET_INDEX_TYPE(mtpio::chain::index_long_double_object, mtpio::chain::index_long_double_index)

FC_REFLECT(mtpio::chain::table_id_object, (code)(scope)(table)(payer)(count) )
FC_REFLECT(mtpio::chain::key_value_object, (primary_key)(payer)(value) )

#define REFLECT_SECONDARY(type)\
  FC_REFLECT(type, (primary_key)(payer)(secondary_key) )

REFLECT_SECONDARY(mtpio::chain::index64_object)
REFLECT_SECONDARY(mtpio::chain::index128_object)
REFLECT_SECONDARY(mtpio::chain::index256_object)
REFLECT_SECONDARY(mtpio::chain::index_double_object)
REFLECT_SECONDARY(mtpio::chain::index_long_double_object)
