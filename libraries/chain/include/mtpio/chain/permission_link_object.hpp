...
CHAINBASE_SET_INDEX_TYPE(mtpio::chain::permission_link_object, mtpio::chain::permission_link_index)

FC_REFLECT(mtpio::chain::permission_link_object, (account)(code)(message_type)(required_permission))
