...
FC_REFLECT_ENUM( mtpio::chain::transaction_receipt::status_enum,
                 (executed)(soft_fail)(hard_fail)(delayed)(expired) )

FC_REFLECT(mtpio::chain::transaction_receipt_header, (status)(cpu_usage_us)(net_usage_words) )
FC_REFLECT_DERIVED(mtpio::chain::transaction_receipt, (mtpio::chain::transaction_receipt_header), (trx) )
FC_REFLECT(mtpio::chain::additional_block_signatures_extension, (signatures));
FC_REFLECT_DERIVED(mtpio::chain::signed_block, (mtpio::chain::signed_block_header), (transactions)(block_extensions) )
